...
const MovieInformation = () => {
  ...
  const { data: recommendationsData, isLoading: recommendationsIsLoading, isFetching: recommendationsIsFetching, error: recommendationsError } = useGetRecommendationsQuery({ list: '/recommendations', movieId: id });
      ...
      <Grid item container direction="column" lg={7}>
        ...
        <Grid item className={classes.containerSpaceAround}>
          ...
          <Typography variant="h6" align="center" gutterBottom>
            {data?.runtime} minutes | Language: {data?.spoken_languages[0].name}
          </Typography>
        </Grid>
